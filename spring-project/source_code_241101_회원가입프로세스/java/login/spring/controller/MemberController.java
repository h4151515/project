...
public class MemberController {
    ...
    public String createMember() {
        System.out.println(getClass() + "   createMember() process completed");
    ...
    public String list(Model model) {
        ...
        System.out.println(getClass() + "   getMemberList() ");
    ...
    public String deleteMember(@PathVariable("id") Long memberid) {
        ...
        if(findMember.isPresent()) {
            System.out.println(getClass() + "   deleteMember() delete Info : " + findMember.toString());
    ...
    public String updateMember(@PathVariable("id") Long id, Model model) {
        ...
        System.out.println(getClass() + "   updateMember() process complete");
    ...
    public String updateMember(@Valid @ModelAttribute("memberForm") MemberForm form, BindingResult bindingResult) {
        if(bindingResult.hasErrors()) {
            return "/admin/updateMemberForm";
        }
        EzenMember member = new EzenMember();
        ...
        System.out.println(getClass() + "   updateMember() userInfo (" + member.getLoginId() + ", " + member.getName() + ", [id:" + member.getId() + "])");
